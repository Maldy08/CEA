...
{
    public record GenerateFormatosPdf: IRequest<Stream>
    {
        public int Ejercicio { get; init; }
        public int Oficina { get; init; }
        public int Noviat { get; init; }

        public GenerateFormatosPdf(int ejercicio, int oficina, int noviat)
        {
            Ejercicio = ejercicio;
            Oficina = oficina;
            Noviat = noviat;
    ...
    internal class GenerateFormatosPdfHandler : IRequestHandler<GenerateFormatosPdf, Stream>
    {
        private readonly IFormatoComisionRepository _formatoComisionRepository;
        public GenerateFormatosPdfHandler(IFormatoComisionRepository formatoComisionRepository)
        {
            _formatoComisionRepository = formatoComisionRepository;
        }

        public async Task<Stream> Handle(GenerateFormatosPdf request, CancellationToken cancellationToken)
        {
            var result = await _formatoComisionRepository.GetFormatoComisionByOficinaEjercicioNoviat(request.Oficina, request.Ejercicio, request.Noviat);
