...
namespace CEA.WebAPI.Controllers.Oficios
{
    ...
    public class OficioController : ControllerBase
    {
        ...
        public OficioController(IMediator mediator, IOficioRepository oficioRepository)
        {
            _mediator = mediator;
        ...
        public async Task<ActionResult<Result<List<Oficio>>>> GetOficiosMCByEorAndEjercicio(int eor, int ejercicio)
        {
